<?php
 ...
 ?>
    ...
    <div class="slider-area pos-relative">
        <div class="slider-active">
          <?php
           ...
           ?>
            <div class="single-slider slider-height d-flex align-items-center justify-content-center" style="background-image: url('admin/upload/<?= $bdata['ban_pic'];?>');">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-9 col-md-12">
                            <div class="slider-content slider-content-2">
                                ...
                                <a class="theme-btn" data-animation="fadeInUp" data-delay=".6s" href="<?= $bdata['ban_url'];?>"><span class="btn-text"><?= $bdata['ban_button'];?></span></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="about" class="about-area pt-100 pb-70">
        <div class="container">
          <?php
            $sel="SELECT * FROM adm_sikkha ORDER BY sik_id DESC LIMIT 0,1";
            $q=mysqli_query($con,$sel);
            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7">
                    <div class="about-title-section mb-30">
                        <h1><?= $sdata['sik_title'];?></h1>
                        <p><?= $sdata['sik_subtitle'];?>.</p>
                        <a class="theme-btn blue-bg-border mt-20" href="<?= $sdata['sik_url'];?>"><span class="btn-text"><?= $sdata['sik_button'];?></span></a>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-5">
                    <div class="about-right-img mb-30">
                        <img width="400px" src="admin/upload/<?= $sdata['sik_pic'];?>" alt="image">
                    </div>
                </div>
            </div>
          <?php } ?>
            ...
            <div class="row pt-65">
              <?php
                $i=1;
                $sel="SELECT * FROM adm_feature ORDER BY feat_id DESC LIMIT 0,3";
                $q=mysqli_query($con,$sel);
                while($fdata=mysqli_fetch_assoc($q)){
               ?>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="feature-wrapper mb-30">
                        <div class="feature-title-heading">
                            <h3><?= $fdata['feat_title'];?></h3>
                            <span><?= '0'.$i++; ?></span>
                        </div>
                        <div class="feature-text">
                            <p><?= $fdata['feat_subtitle'];?>.</p>
                        </div>
                    </div>
                </div>
              <?php } ?>
