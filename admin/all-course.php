                          ...
                          <table class="table table-responsive table-striped table-hover table_cus">
                                ...
                                <tbody>
                                  ...
                                  <?php
                                   ...
                                   ?>
                                	<tr>
                                    	<td><?= substr($data['course_title'],0,10); ?>...</td>
                                      <td><?= substr($data['course_subtitle'],0,20); ?>...</td>
                                      <td><?= $data['course_category']; ?></td>
                                      <td><?= $data['course_detail']; ?></td>
                                      <td><img width="50" src="upload/<?= $data['course_pic'];?>" alt="image"></td>
                                      <td><img width="50" src="upload/<?= $data['course_author_pic'];?>" alt="image"></td>
